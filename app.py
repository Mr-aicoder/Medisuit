...
# Import Google Generative AI (assuming you're using it)
...
GOOGLE_API_KEY = "AIzaSyDPJIu14LFr9YQPnUT4ie3iWI3ixpNRsYg"
# ------------------------------------
...
class MediSuiteGUI:
    def __init__(self, root):
        ...
        self.llm = genai.GenerativeModel('gemini-pro') # You can choose other models if needed

        self.agent = MedicalCodingAgent(llm=self.llm) # Pass the llm object here
    ...
    def reset_conversation(self):
        ...
        if messagebox.askyesno("Reset Conversation", "Are you sure you want to reset the conversation?"):
            ...
            # Reset agent state
            self.agent = MedicalCodingAgent(llm=self.llm) # Pass the llm object here as well
            self.agent.current_state = "greeting"
