...
class MedicalCodingAgent:
    def __init__(self, llm: LLMInterface, icd10_data_path="ICD10.json", cpt4_data_path="CPT4.json", pdf_builder=None,
        ...
        if tesseract_cmd:
            pytesseract.pytesseract.tesseract_cmd = "C:/Users/Sachin Tupsamundar/Downloads/tesseract-ocr-w64-setup-5.5.0.20241111.exe"

        # Configure Poppler path
        self.poppler_path = "C:/Program Files/poppler-24.01.0/Library/bin"
